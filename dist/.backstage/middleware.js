...
const MOCK_PRODUCTS = require('./mocks/products.json').map((product) => (Object.assign(Object.assign({}, product), { name: generateStupidName(), description: getRandomFromArray(DESCRIPTIONS), src: `/assets/products/p${getRandomFromArray(Array.from({ length: 25 }, (v, k) => k + 1))}.webp` })));
